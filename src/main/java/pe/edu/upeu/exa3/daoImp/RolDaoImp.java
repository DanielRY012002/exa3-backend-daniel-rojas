...
public class RolDaoImp implements RolDao{
	...
	public Map<String, Object> read(int id) {
		simpleJdbcCall = new SimpleJdbcCall(jdbcTemplate).withCatalogName("pk_roles") // nombre del paquete
				...
				.declareParameters(
						...
						new SqlParameter("idrol", OracleTypes.NUMBER));
	...
	public Map<String, Object> readAll() {
		simpleJdbcCall = new SimpleJdbcCall(jdbcTemplate).withCatalogName("pk_roles")
				.withProcedureName("sp_listar_roles").declareParameters(
						new SqlOutParameter("cursor_roles", OracleTypes.REF_CURSOR, new ColumnMapRowMapper()));
	...
	public List<GrantedAuthority> buscarRolUser(int iduser) {
		...
		String SQL = "SELECT r.idrol, r.nombre FROM usuarios u "
				...
				+ "INNER JOIN roles r ON r.idrol=ur.idrol " + "WHERE u.idusuario = ?";
